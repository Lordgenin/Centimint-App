    ...
    var body: some View {
        ZStack {
            ...
            ScrollView(.vertical, showsIndicators: false) {
                VStack(alignment: .leading) {
                    ...
                    VStack(alignment: .leading) {
                        ...
                        TextFieldWithIcon(text: $oldPassword, placeholder: "Old Password", icon: .sfSymbol(.lock, color: .black), isSecure: true)
                            .padding(.bottom)
                        ...
                        TextFieldWithIcon(text: $newPassword, placeholder: "New Password", icon: .sfSymbol(.lock, color: .black), isSecure: true)
                            .padding(.bottom)
                        ...
                        TextFieldWithIcon(text: $confirmPassword, placeholder: "Confirm New Password", icon: .sfSymbol(.lock, color: .black) , isSecure: true)
                            .padding(.bottom)
                    }
                    ConfirmationButton(title: "Update Password", type: .primaryLargeConfirmation) {
                    ...
                    ConfirmationButton(title: "Cancel", type: .primaryLargeConfirmation) {
            ...
            if viewModel.showToast {
                VStack {
                    Spacer()
                    ToastView(viewModel: ToastViewModel(message: "", backgroundColor: Color.black, textColor: Color.black))
                    .padding()
                }
            }
        }
